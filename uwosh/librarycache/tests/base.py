...
def setup_product():
    ...
    import uwosh.librarycache
    zcml.load_config('configure.zcml', uwosh.librarycache)
    ...
    ztc.installPackage('uwosh.librarycache')
...
setup_product()
ptc.setupPloneSite(products=['uwosh.librarycache'])
